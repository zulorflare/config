...
beautiful.init("/home/zul/.config/awesome/theme.lua")
...
tags = {
	names = {"main", "www", "im", "etc", "devel"},
	layout = {layouts[2], layouts[8], layouts[2], layouts[8], layouts[2]}
}
...
--end
--run_once("xmcabber j.org")
--run_once("xmcabber j.u.ru")
--run_once("firefox")

awful.util.spawn_with_shell("xxkb &")
awful.util.spawn_with_shell("mpd-widget &")
